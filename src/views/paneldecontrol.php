...
<div class="taulaapartaments scrollable-table">
    <form method="POST" action="index.php?r=addapartment">
        <table class="table table-striped">
            ...
            <tbody>
                <tr>
                    <td><input type="text" class="form-control" name="title" placeholder="Título" required></td>
                    <td><input type="text" class="form-control" name="postal_address" placeholder="Dirección Postal" required></td>
                    <td><input type="text" class="form-control" name="length" placeholder="Longitud" required></td>
                    <td><input type="text" class="form-control" name="latitude" placeholder="Latitud" required></td>
                    <td><input type="text" class="form-control" name="short_description" placeholder="Descripción Corta" required></td>
                    <td><input type="text" class="form-control" name="square_metres" placeholder="Metros Cuadrados" required></td>
                    <td><input type="text" class="form-control" name="number_rooms" placeholder="Número de Habitaciones" required></td>
                    <td><input type="text" class="form-control" name="services_extra" placeholder="Servicios Extra" required></td>
                    <td><input type="text" class="form-control" name="price_day_low_season" placeholder="Precio en Temporada Baja" required></td>
                    <td><input type="text" class="form-control" name="price_day_high_season" placeholder="Precio en Temporada Alta" required></td>
