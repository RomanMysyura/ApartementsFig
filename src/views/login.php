    ...
    <div class="container mt-5">
        ...
        ?>
                    <form action="" method="POST">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    aria-describedby="emailHelp" placeholder="Introdueix el teu correu" />
                            </div>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <p class="text-center text-white">No tens cap compte? <a href="index.php?r=signup"
                                    class="text-decoration-none text-primary-emphasis">Registra't</a></p>
                        </div>
                    </form>
                </div>
            </div>
